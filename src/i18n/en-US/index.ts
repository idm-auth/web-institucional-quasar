export default {
  ...
  privacy: {
    ...
    dataCollected: {
      ...
      content: 'We collect the following information when you visit our site:',
      items: {
        item1: 'Browsing data: IP address, browser type, pages visited, time spent',
        item2: 'Cookies and similar technologies for site usage analysis',
        item3: 'Information voluntarily provided through contact forms',
        item4: 'Analytics data through Google Analytics (only with your consent)',
      },
    },
    howWeUse: {
      ...
      items: {
        item1: 'Improve user experience and site content',
        item2: 'Analyze traffic and visitor behavior',
        item3: 'Respond to contact and support requests',
      },
    },
    cookies: {
      title: 'Cookies',
    ...
    yourRights: {
      ...
      items: {
        ...
        item2: 'Withdraw your consent for analytics cookies at any time',
        item3: 'Request portability of your data',
        item4: 'Lodge a complaint with a data protection authority',
      },
    },
    security: {
      title: 'Security',
  ...
  terms: {
    ...
    license: {
      ...
      content: 'We grant you a limited, non-exclusive and non-transferable license to:',
      items: {
    ...
    prohibited: {
      ...
      items: {
        item1: 'Use the site for any illegal or unauthorized purpose',
        item2: 'Attempt to gain unauthorized access to any part of the site',
        item3: 'Copy, modify or distribute site content without permission',
        item4: 'Use our name, logos or trademarks without express written authorization',
      },
    },
    intellectual: {
